...
CLOUD_INIT_FILE='ubuntu-docker-cloudinit.yaml'

VM_ID=10020
STORAGE_GB='32G'
VM_TEMPLATE="ubuntu-noble-docker-${STORAGE_GB}"
PVE_STORAGE='shared-templates'
NETWORK_BRIDGE='vmbr0'
TEMPLATE_TAGS='ubuntu-noble,docker,cloudinit'
...
wget -q https://cloud-images.ubuntu.com/minimal/releases/noble/release/${IMAGE_FILE}
